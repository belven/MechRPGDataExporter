...
public class App {
	...
	static {
		tablesRows.add(LaserWeapon.CreateLaserWeapon("Test Laser Weapon 1", "Laser 1", 1, 500, 30, false, 1, "Particle Path"));
		tablesRows.add(LaserWeapon.CreateLaserWeapon("Test Laser Weapon 2", "Laser 2", 1, 500, 30, false, 1, "Particle Path"));
		tablesRows.add(LaserWeapon.CreateLaserWeapon("Test Laser Weapon 3", "Laser 3", 1, 500, 30, false, 1, "Particle Path"));
		tablesRows.add(MeleeWeapon.CreateMeleeWeapon("Test Melee Weapon 1", "Melee 1", 1, 500, 30, false, 300));
		tablesRows.add(LaserWeapon.CreateLaserWeapon("Test Laser Weapon 4", "Laser 4", 1, 500, 30, false, 1, "Particle Path"));
		tablesRows.add(MeleeWeapon.CreateMeleeWeapon("Test Melee Weapon 2", "Melee 2", 1, 500, 30, false, 300));
		tablesRows.add(LaserWeapon.CreateLaserWeapon("Test Laser Weapon 5", "Laser 5", 1, 500, 30, false, 1, "Particle Path"));
	...
	private static String[] CreateData(RowData row) {
		/*
		 * String[] oldData = row.CreateData(); String[] data = new String[oldData.length];
		 * 
		 * for (int i = 0; i < oldData.length; i++) { data[i] = oldData[i].replace("\"", ""); }
		 */
